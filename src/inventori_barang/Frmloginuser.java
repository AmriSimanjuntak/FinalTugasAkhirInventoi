 ...
 * @author amris
 */
public final class Frmloginuser extends javax.swing.JFrame {
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        try {
            ...
            rsLogin.last();
            if (rsLogin.getRow()==1){
                UserSession.setU_id(rsLogin.getInt("id"));
                UserSession.setU_username(rsLogin.getString("username"));
                UserSession.setU_password(row_txtpassword);
                UserSession.setU_nama(rsLogin.getString("nama"));
