...
public class FrmakunUser extends javax.swing.JDialog {
    ...
    private void btnsave_passwordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsave_passwordActionPerformed
        ...
        if(!"".equals(row_txtpassword_lama) && !"".equals(row_txtpassword) && !"".equals(row_txtcpassword)){
            if(row_txtpassword_lama.equals(UserSession.getU_password())){
                if(row_txtcpassword.equals(row_txtpassword)){
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tmuser SET password='" + row_txtpassword + "' WHERE id = '" + lblid.getText() + "'");
                        JOptionPane.showMessageDialog(null, "Berhasil mengubah password.");
                        UserSession.setU_password(row_txtpassword);
                        konek.closekoneksi();
                        this.hide();
   ...
   public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmakunUser dialog = new FrmakunUser(new javax.swing.JFrame(), true);
